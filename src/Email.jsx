// src/pages/EmailTemplateList.jsx
    ...
    (async () => {
      try {
        ...
        if (!r.ok) {
          ...
          console.error("EmailTemplateList error:", r.status, txt);
      ...
      <div style={styles.content}>
        <div style={styles.stage}>
          ...
          <div style={styles.breadcrumb}>
            ...
            <span style={{ color: "#3B82F6" }}>Email Template</span>
          </div>
          ...
          <div style={{ display: "flex", justifyContent: "flex-end", marginBottom: 20 }}>
            <button
              ...
              onClick={() => navigate("/email-template/create-email")}
            >
              + Create New Template
            </button>
          </div>
            ...
            <div style={styles.tableWrap}>
              ...
              {view.map((t) => (
                <div key={t.id} style={styles.row}>
                  ...
                  <div>
                    <span style={{ ...styles.statusBadgeBase, ...getStatusClass(t.status) }}>
                      {t.status}
                    </span>
                  </div>
                  <div>
              ...
              {!view.length && (
                <div style={{ padding: 16, color: THEME.textFaint }}>No templates</div>
              )}
            </div>
          )}
